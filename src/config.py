# xjw: if no setting, return default
def cnndm_setting(args):
    # default setting for cnndm
    args.enable_wandb = getattr(args, 'enable_wandb', False)
    args.desc = getattr(args, 'desc', '')
    args.project_name = getattr(args, 'project_name', 'test')
    args.pos_neg_weight = getattr(args, 'pos_neg_weight', 0.1)
    args.enable_wandb = getattr(args, 'enable_wandb', True)
...
def cnndm_cased_setting(args):
    # default setting for cnndm_cased
    args.enable_wandb = getattr(args, 'enable_wandb', False)
    args.desc = getattr(args, 'desc', '')
    args.project_name = getattr(args, 'project_name', 'test')
    args.pos_neg_weight = getattr(args, 'pos_neg_weight', 0.1)
    ...
    args.dataset = getattr(args, "dataset", "cnndm_cased")
    args.max_len = getattr(args, "max_len", 120)
    args.max_num = getattr(args, "max_num", 16)
    args.smooth = getattr(args, "smooth", 0.1)
    args.total_len = getattr(args, "total_len", 1024)
